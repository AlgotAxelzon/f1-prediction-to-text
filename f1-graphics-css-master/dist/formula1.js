...
function NewTrackplate(json, target) {
	let a = ElementAndClass("div", "f1 trackplate-short");

	let text = ElementAndClass("div", "text");
	let gpname = ElementAndClass("div", "gp-name");
	gpname.innerText = json.raceName;
	let circuitname = ElementAndClass("div", "circuit-name");
	circuitname.innerText = json.circuit.circuitName;
	text.appendChild(gpname);
	text.appendChild(circuitname);
	a.appendChild(text);

	//let picture = ElementAndClass("div", "picture");
